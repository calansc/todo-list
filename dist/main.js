...
const todoAddText = ["Todo Name:", "Description:", "Due Date:", "Priority:", "Project:"];
const todoAddPlaceholder = ["Task Name", "Task Description...", "", "", "Project?"];
...
function dropDown() {
  ...
  dropDownDiv.addEventListener("mouseenter", function (e) {
...
function resetSelectedProject() {
  for (let i = 0; i < document.querySelectorAll(".tabs > .projectTab").length; i++) {
    document.querySelectorAll(".tabs > .projectTab")[i].classList.remove("selectedTab");
  }
}
...
addTodoButton[0].addEventListener("click", function () {
