...
function addForm() {
  ...
  dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dueDate), "M/d/yy");
...
function editTodo(thisArray, todoListId) {
  ...
  for (let i = 0; i < thisArray.length; i++) {
    ...
    if (todoAddKey[i] === "dueDate") {
      // console.log(thisArray[i]);
      let newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(thisArray[i]), "yyyy-MM-dd");
      // console.log(newDate);
      const div = document.createElement("div");
      div.classList.add("formDiv");
      const label = document.createElement("label");
...
function editForm(todoListId) {
  ...
  let newDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(dueDateReplace), "M/d/yy");
  let priority = document.getElementById("priority").value;
  let project = document.getElementById("project").value;
  // console.log(todoListId);
...
function headerRefresh() {
  ...
  header.appendChild((0,_addTodo_js__WEBPACK_IMPORTED_MODULE_0__.addTodo)());
  header.appendChild((0,_project__WEBPACK_IMPORTED_MODULE_2__.projectTabs)());
  header.appendChild((0,_project__WEBPACK_IMPORTED_MODULE_2__.createProject)());
  header.appendChild((0,_project__WEBPACK_IMPORTED_MODULE_2__.removeProject)());
  const addButton = document.querySelector(".addTodo");
...
if (window.localStorage.length === 0) {
  ...
  (0,_storage_js__WEBPACK_IMPORTED_MODULE_3__.retrieveStorage)();
}
...
const header = document.getElementById("header");
const content = document.getElementById("content");
(0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.contentRefresh)();
(0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.headerRefresh)();
